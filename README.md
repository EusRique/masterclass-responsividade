...
Hoje vamos usar estratégias de CSS Units para que tanto o nosso Layout, quanto os nossos textos, fiquem fluidos. 
...
![](https://github.com/EusRique/masterclass-responsividade/blob/master/responsivo.gif)